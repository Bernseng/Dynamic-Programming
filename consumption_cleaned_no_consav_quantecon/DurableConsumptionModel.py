...
class DurableConsumptionModelClass():   #(ModelClass):
    ...
    def __init__(self,name='EconModelClass', **kwargs):
            ...
            with jit(self) as model:
                ...
                # ii. all other periods
                    ...
                    if do_assert:
                        ...
                        assert np.all((sol.inv_v_adj[t] >= 0) & (np.isnan(sol.inv_v_adj[t]) == False)), t #sol.inv_v_adj[t] #print(f"T={t}, isol.inv_v_adj[t] = {sol.inv_v_adj[t]}")
